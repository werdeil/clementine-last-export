...
def connect_server(username, startpage, server):
...
def main(username, startpage, outfile, server):
    trackdict = dict()
    page = startpage
    response = connect_server(username, page, server)
...
if __name__ == "__main__":
    ...
    main(username, startpage, outfile, server)
